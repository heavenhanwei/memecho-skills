...
- **可视化报告**：Markdown 内置 ASCII 可信度/VAD 图，或输出可离线打开的响应式 HTML 报告。
...
GitHub Release 附带适用于 SkillHub 等 Agent Skills 平台的 `memecho-analyze-conversation-v1.0.2.zip`。压缩包顶层直接包含 `SKILL.md`，并附 `SHA256SUMS.txt` 用于完整性校验。

```bash
python scripts/build_release.py
```

版本历史见 [CHANGELOG](CHANGELOG.md)，本次发布说明见 [RELEASE_NOTES_1.0.2](RELEASE_NOTES_1.0.2.md)。
